    ...
    render: function(){
        return (
            React.createElement("div", {className: "radio-element"}, 
                React.createElement("input", {type: "radio", id: this.props.id, name: this.props.name, "data-type": this.props.type, onChange: this.props.function.bind(null, this.props.type)}), 
...
var RadiosGroup = React.createClass({displayName: "RadiosGroup",
    render: function() {
        ...
        var elements = typesData.map(function(type, index){
            return React.createElement(RadioElement, {type: keys[type], fullName: keys[type]['name'], name: name, id: name + index, function: this.props.function})
        });
        return (
