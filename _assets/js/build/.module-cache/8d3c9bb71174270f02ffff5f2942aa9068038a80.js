...
var RadioElement = React.createClass({displayName: "RadioElement",
    radioChecked: function(element,type) {
        if (!element.checked) {
            console.log(type);
        }
    },
    render: function(){
        return (
            React.createElement("div", {className: "radio-element"}, 
                React.createElement("input", {type: "radio", id: this.props.id, "data-type": this.props.type, name: this.props.name, onChange: this.radioChecked.bind(this.props.type)}), 
