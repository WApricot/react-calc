    ...
    render: function(){
        return (
            React.createElement("div", {className: "radio-element"}, 
                React.createElement("input", {type: "radio", id: this.props.id, name: this.props.name, "data-type": this.props.type, onChange: this.radioChecked.bind(null, this.props.type)}), 
