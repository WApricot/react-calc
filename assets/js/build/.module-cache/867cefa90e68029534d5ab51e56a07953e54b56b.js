...
var RadiosGroup = React.createClass({displayName: "RadiosGroup",
    render: function() {
        var typesData = Object.keys(this.props.keys);
        var elements = typesData.map(function(type, index){
            return React.createElement(RadioElement, {type: type, fullName: type['name'], name: this.props.name, id: this.props.name + index})
        });
        return (
            React.createElement("div", {className: "radios-block", className: this.props.name}, 
                elements
            )
        )
    }
...
var ColorsBlock = React.createClass({displayName: "ColorsBlock",
    render: function() {
        var typesData = Object.keys(data['sheet']);
        var elements = typesData.map(function(type, index){
            return React.createElement(RadioElement, {type: type, fullName: type['name'], name: 'type-block', id: 'type-block' + index})
